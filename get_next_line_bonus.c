...
/*   Updated: 2023/01/21 22:58:49 by nait-ali         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main()
{
int fd = open("naoual",O_RDONLY);
int fdd = open("get_next_line_bonus.c",O_RDONLY);
char *p1 = get_next_line(fd);
char *p2 =  get_next_line(fdd);
while ( p1 && p2 )
{
	printf("%s\n", p1);
	printf("%s", p2);
	p1 = get_next_line(fd);
    p2 =  get_next_line(fdd);
